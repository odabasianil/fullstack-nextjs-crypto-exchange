    ...
    <>
      <div className="flex flex-col lg:flex-row lg:justify-between">
        <div className="w-full lg:min-w-[520px] lg:w-[520px] !max-w-full">
          ...
          <Step title={t('withdraw.withdraw_to')} index={2} isActive={selectedCrypto ? true : false}>
            <WithdrawTo
              address={address}
          ...
          <Step title={t('withdraw.withdraw_amount')} index={3} isActive={address?.length > 0 && (selectedNetwork || selectedAddress?.blockchainId)} isLast>
            <WithdrawAmount
