...
export const StopLimitForm = (props: StopLimitInterface) => {
    ...
    <>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-1 text-xs  flex items-center justify-between gap-2">
          <div className="text-gray-300 dark:text-gray-400 dark:md:text-gray">Max Buy</div>
          <div>0 {coin1}</div>
        </div>
        {/* <div className="mb-1 text-xs flex items-center justify-between gap-2">
          <div className="text-gray-300 dark:text-gray-400 dark:md:text-gray">Est. Fee</div>
          <div>0 {coin1}</div>
        </div> */}
        {
