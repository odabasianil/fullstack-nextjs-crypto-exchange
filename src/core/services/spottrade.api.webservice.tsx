...
export const ORDERBOOK_BASE_URL = process.env.NEXT_PUBLIC_ORDERBOOK_API_URL!;
export const ORDERBOOKSOCKET_BASE_URL = process.env.NEXT_PUBLIC_ORDERBOOK_SOCKET_URL!;
...
let store: any;
export const SpotTradeInjectStore = (_store: any) => {
    if(!store){
        store = _store;
    }
};
